...
from model.decision_no_rule import Module
...
if __name__ == '__main__':
    ...
    if args.debug:
        limit = 27
        data = {k: torch.load('{}/proc_{}_{}_no_rule_change_VAT2loan.pt'.format(args.data, args.data_type, 'dev'))[:limit] for k in ['train', 'dev']}
    else:
        limit = None
        data = {k: torch.load('{}/proc_{}_{}_no_rule_change_VAT2loan.pt'.format(args.data, args.data_type, k))[:limit] for k in ['dev', 'train']}
