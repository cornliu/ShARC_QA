...
class Module(nn.Module):
    ...
    def __init__(self, args, device='cpu'):
        ...
        self.w_selfattn = nn.Linear(self.args.bert_hidden_size, 1, bias=True)
    ...
    def forward(self, batch):
        ...
        for idx, e in enumerate(batch):
            ...
            # tenc_idx = e['entail']['user_idx'].to(self.device)
        ...
        cat_state = tenc_out_t[:, :max_num_rule_in_batch, :]
